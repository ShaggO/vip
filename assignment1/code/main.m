...
disp('I4 results:');
disp([num2str(size(p41,1)) ' blobs found (log)']);
disp([num2str(size(p42,1)) ' blobs found (dog)']);
disp([num2str(size(p43,1)) ' corners found (harris)']);

% Show individual images
% Out-commented since all points are drawn on common images below
...
displayAllPoints(I4,{p41,p42,p43}, {'LoG','DoG','Harris'}, {'xr','og','sy'}, [imfolder 'i4_points']);
...
matches7 = salientMatch(I1,I2,p13,p23, 0.8, [51 51]);
...
matches8 = salientMatch(I1,I3,p13,p33, 0.8, [51 51]);
...
displayMatches(I1,I2,p13,p23, matches7, 'Harris I1, I2 [51x51]', [imfolder 'match_i1_i2_harris_51']);
...
displayMatches(I1,I3,p13,p33, matches8, 'Harris I1, I3 [51x51]', [imfolder 'match_i1_i3_harris_51']);
